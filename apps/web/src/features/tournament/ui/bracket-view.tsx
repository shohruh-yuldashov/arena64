 ...
 *
 * ## No canvas, no zoom, no connectors
 *
 * §13 rules out drag and zoom. Connector lines are left out too, which is a
 * deliberate trade rather than an omission: drawing them means absolute
 * positioning and fixed row heights, and fixed heights are what stop a
 * bracket reflowing at 360px. The relationship is carried by the round
 * heading and the slot number instead, which is also what makes it
 * available to a screen reader — a connector line is invisible to one.
 *
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        ...
        tabIndex={0}
        className="focus-visible:ring-ring flex gap-4 overflow-x-auto pb-2 focus-visible:ring-2 focus-visible:outline-none"
      >
