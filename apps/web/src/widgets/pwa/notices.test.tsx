...
it("offers installation only after sign-in, and remembers both answers", async () => {
  ...
  // A64-026.1 §40. The anonymous landing page's `<h1>` is a sentence about
  // the product rather than the wordmark, so this waits for the route to
  // have rendered at all rather than for one particular title.
